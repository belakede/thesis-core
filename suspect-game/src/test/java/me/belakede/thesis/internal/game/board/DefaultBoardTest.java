...
public class DefaultBoardTest {
    ...
    public static final class DefaultBoardMiscTest {

        @Test(expected = UnsupportedOperationException.class)
        public void testGetStartingFieldsShouldThrowUnsupportedOperationExceptionWhenTryToInsertANewValue() throws
                Exception {
            // GIVEN
        ...
        @Test(expected = UnsupportedOperationException.class)
        public void testGetRoomFieldsShouldThrowUnsupportedOperationExceptionWhenTryToInsertANewValue() throws
                Exception {
            // GIVEN
        ...
        @Test
        public void testIsAvailableShouldReturnFalseWhenFromAndToAreSimpleFieldsAndDistanceIsThirteen() throws
                Exception {
            // GIVEN
            BoardTestData testData = getComplexBoardInstallation();
            Board testSubject = testData.getBoard();
        ...
        @Test
        public void testIsAvailableShouldReturnTrueWhenFromAndToAreRoomFieldsAndDistanceIsNineteenButHasSecretPassageBetweenThem
                () throws Exception {
            // GIVEN
            BoardTestData testData = getComplexBoardInstallation();
            Board testSubject = testData.getBoard();
        ...
        @Test
        public void testIsAvailableShouldReturnTrueWhenFromAndToAreRoomFieldsAndDistanceIsMoreThenThirteenButDoorsDistanceOnlyEight
                () throws Exception {
            // GIVEN
            BoardTestData testData = getComplexBoardInstallation();
            Board testSubject = testData.getBoard();
        ...
        @Test
        public void testAvailableFieldsShouldReturnTheSetOfFieldsInRoomWhenFromIsARoomFieldStepIsZeroAndThereIsNoSecretPassageToAnotherRoom
                () throws Exception {
            // GIVEN
            BoardTestData testData = getComplexBoardInstallation();
            Board testSubject = testData.getBoard();
        ...
        @Test
        public void testAvailableFieldsShouldReturnTheSetOfFieldsInTwoRoomWhenFromIsARoomFieldStepIsZeroAndThereIsASecretPassageToAnotherRoom
                () throws Exception {
            // GIVEN
            BoardTestData testData = getComplexBoardInstallation();
            Board testSubject = testData.getBoard();
